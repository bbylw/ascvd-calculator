const translations = {
    zh: {
        ...
        advice: {
            ...
            followup: "每3-6个月复查一次",
            lowRisk: {
                guidelines_base: "以下建议基于最新国际指南：\n" +
                    "• 2023 ADA糖尿病诊疗标准\n" +
                    "• 2019 ACC/AHA心血管疾病预防指南\n" +
                    "• 2021 ESC心血管疾病预防指南",
                lifestyle: "生活方式建议 (ACC/AHA & ESC)：\n" +
                    "- 每周进行150-300分钟中等强度或75-150分钟高强度有氧运动\n" +
                    "- 遵循地中海饮食模式\n" +
                    "- 维持健康体重（BMI <25 kg/m²）",
                bp_treated: "高血压管理 (ACC/AHA)：\n" +
                    "- 血压控制目标 <130/80 mmHg\n" +
                    "- 坚持服药并每周监测血压\n" +
                    "- 定期随访评估用药效果",
                bp_untreated: "高血压管理 (ACC/AHA)：\n" +
                    "- 建议就医评估降压治疗\n" +
                    "- 血压控制目标 <130/80 mmHg",
                diabetes: "糖尿病管理 (ADA 2023)：\n" +
                    "- HbA1c控制目标 <7%\n" +
                    "- 优先考虑SGLT2抑制剂\n" +
                    "- 定期监测血糖和肾功能\n" +
                    "- 每3-6个月进行HbA1c检查",
                lipids: "血脂管理 (ESC 2021)：\n" +
            ...
            moderateRisk: {
                guidelines_base: "以下建议基于最新国际指南：\n" +
                    ...
                    "• 2019 ACC/AHA心血管疾病预防指南\n" +
                    "• 2021 ESC心血管疾病预防指南",
                lifestyle: "强化生活方式干预 (ACC/AHA & ESC)：\n" +
                    "- 每周运动时间增加到300分钟以上\n" +
                    "- 严格执行地中海饮食\n" +
                    "- 限制钠摄入（<2000mg/日）",
                bp_treated: "高血压管理 (ACC/AHA)：\n" +
                ...
                diabetes: "糖尿病管理 (ADA 2023)：\n" +
                    ...
                    "- 考虑GLP-1受体激动剂\n" +
                    "- 每3个月监测血糖和HbA1c",
                lipids: "血脂管理 (ESC 2021 & ACC/AHA)：\n" +
                    "- LDL-C 目标值 <1.8 mmol/L (70 mg/dL)\n" +
                    "- 建议使用中等强度他汀（如阿托伐他汀20-40mg）\n" +
                    "- 如3个月未达标，考虑增加剂量\n" +
                    "- 每6个月监测血脂水平"
            },
            highRisk: {
                ...
                lipids: "血脂管理 (ESC 2021)：\n" +
                    ...
                    "- 如仍未达标，考虑PCSK9抑制剂\n" +
                    "- 每3个月监测血脂水平",
                antiplatelet: "抗血小板治疗 (ACC/AHA)：\n" +
                    "- 考虑使用阿司匹林进行一级预防\n" +
                    "- 需权衡出血风险",
                monitoring: "定期监测 (ACC/AHA & ESC)：\n" +
                    "- 每周血压监测\n" +
                    "- 每3个月血脂监测\n" +
                    "- 每3-6个月肝功能和肌酶\n" +
                    "- 每年评估肾功能"
